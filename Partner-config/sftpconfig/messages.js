...
const messages = defineMessages({
  ...
  partnerId: {
    id: 'SFTPForm.partnerId',
    description: 'Label text for Partner ID in SFTPForm',
   ...
   * */
  listPageTitle: {
    id: 'ProviderList.listPageTitle',
    description: 'The title of the page for the Provider Configurations',
    defaultMessage: 'Partner Configurations',
  },
  displayLabel: {
    id: 'ProviderList.displayLabel',
    description: 'Label for name column',
    defaultMessage: 'Name',
  },
  authenticationMode: {
    id: 'ProviderList.authenticationMode',
    description: 'Label for Authentication Mode column',
    defaultMessage: 'Authentication Mode',
  },
  contentIn: {
    id: 'ProviderList.contentIn',
    description: 'Label for Content Ingestion',
    defaultMessage: 'Content Ingestion',
  },
  launchMode: {
    id: 'ProviderList.launchMode',
    description: 'Label for Launch Mode',
    defaultMessage: 'Launch Mode',
  },
  track: {
    id: 'ProviderList.track',
    description: 'Label for tracking',
    defaultMessage: 'Tracking',
  },
  activeSince: {
    id: 'ProviderList.activeSince',
    description: 'Label for Active Since column',
    defaultMessage: 'Active Since',
  },
  actions: {
    id: 'ProviderList.actions',
  ...
  emptySftpTitle: {
    ...
    defaultMessage:
      'Oooops… It looks like there are no Partner configurations here',
  },
